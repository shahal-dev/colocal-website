    ...
    <nav class="flex items-center justify-between px-60 py-4 bg-white">
        ...
        <div class="flex items-center space-x-4 font-sans font-semibold">
            ...
            <div class="relative group navbar-item">
                ...
                <div class="absolute left-0 mt-3 w-48 bg-white rounded-xl border-1 opacity-0 border-slate-200 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                    <div class="py-1">
                        <a href="/about" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 border-b-1 border-slate-200">Our Story</a>
                        <a href="/team" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 border-b-1 border-slate-200">Team</a>
                        <a href="/mission" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Mission</a>
                    </div>
                </div>
            </div>

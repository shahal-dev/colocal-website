<template>
  <div
    ...
    tabindex="0"
    class="relative z-0 isolate overflow-hidden h-96 md:h-[600px] w-full bg-home-carousel"
    ...
    <transition :name="transitionName" mode="out-in">
      <div :key="currentIndex" class="h-full w-full flex flex-col md:flex-row">
        ...
        <div class="flex flex-col justify-center items-start px-6 md:pl-24 md:pr-20 flex-1">
          ...
          <p class="m-0 mb-8 text-lg md:text-lg font-display font-medium text-white">
...
const liveMessage = ref(
  `Slide ${currentIndex.value + 1} of ${carouselItems.value.length}: ${currentItem.value.title}`
);

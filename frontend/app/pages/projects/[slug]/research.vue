...
// Publications data (reuse layout from project home Featured Publications)
const allPublications = ref([
  ...
  },
  {
    ...
    excerpt: 'Pathways for building community resilience through inclusive adaptation planning.',
  ...
  {
    id: 3,
    title: 'Urban Heat and Health Risks',
    authors: ['Samira Khan'],
    excerpt: 'Evidence on urban heat islands and implications for public health.',
    tags: ['Urban', 'Health'],
    type: 'Policy Brief',
    year: 2022,
    theme: 'Health',
  ...
  {
    id: 5,
    title: 'Coastal Mangrove Restoration Outcomes',
    authors: ['Priya Singh', 'Rahman'],
    excerpt: 'Longitudinal outcomes of mangrove restoration across pilot sites.',
    tags: ['Coastal', 'Restoration'],
    type: 'Journal Article',
    year: 2021,
    theme: 'Ecosystems',
    country: 'Bangladesh',
